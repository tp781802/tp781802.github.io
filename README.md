...
<center>
<button style='background-color:white;border-color:black;height:50px;width:200px;font-size:1em' type = "button" onclick="window.location.href = 'tp781802guessing.github.io';">Guessing Game</button>
